class AppController {
  ...
  exportBackup() { const backup=JSON.stringify(this.model.createBackup(),null,2); this.download(new Blob([backup],{type:"application/json"}),"jarc-database-v9-backup.json"); this.view.toast("Full backup exported"); }
